  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link href="/fatura-yeni" className="primary-button">
      ...
      <section
        ...
        aria-label="Fatura özeti"
      >
        <MetricCard
          label="Bugünkü kayıt"
          value={stats.today_count}
          detail="Bugün oluşturuldu"
          icon={Sparkles}
          tone="gold"
        />
        ...
        <MetricCard
          ...
          detail={formatCurrency(stats.waiting_total)}
          icon={Clock3}
          tone="amber"
        />
        ...
        <MetricCard
          ...
          detail={formatCurrency(stats.completed_total)}
          icon={CheckCircle2}
          tone="green"
        />
        ...
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted">
              En son kaydedilen 5 işlem
            </p>
          </div>

          <Link
            href="/ara"
            className="text-xs font-bold text-gold-700 hover:underline dark:text-gold-300"
          >
            Tümünü gör
          </Link>
        </div>
