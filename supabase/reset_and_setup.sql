...
drop function if exists public.create_invoice(text, text, text, numeric, numeric, public.invoice_status);
drop function if exists public.create_invoice(text, text, text, numeric, numeric);
